...
<svg version="1.1" id="hi-adulto" onclick="hi.reset().play();" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
<script src="js/vivus.js"></script>
		<script>
			...
			var hi = new Vivus('hi-adulto', {type: 'scenario-sync', duration: 20, start: 'autostart', dashGap: 20, forceRender: false},
				function () {
					if (window.console) {
